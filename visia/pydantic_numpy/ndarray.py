...
class _CommonNDArray(ABC):
    ...
    @classmethod
    @abstractmethod
    def validate(cls, val: Any, field: Field) -> nd_array_type:
        ...

    @classmethod
    def __get_pydantic_json_schema__(
        cls, field_schema: dict[str, Any], field: Field | None
    ) -> None:
    ...
    @staticmethod
    def _validate(val: Any, field: Field) -> nd_array_type:
...
class PotentialNDArray(Generic[T], nd_array_type, _CommonNDArray):
    ...
    @classmethod
    def validate(cls, val: Any, field: Field) -> Optional[nd_array_type]:
        try:
            return cls._validate(val, field)
        except ValueError:
            return None
